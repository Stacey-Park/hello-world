...
```{r, include=FALSE}
#From REDCAP MTL Menu, export R CSV file w/o survey identifier field and survey timestamp fields. Rename to mtl_menu.csv. 

#Clear existing data and graphics
rm(list=ls())
graphics.off()

#Load Hmisc library (install.packages("Hmisc") if needed)
library(Hmisc)
```

``` {r,echo=FALSE, out.width='.50\\linewidth', fig.width=4, fig.height=4,fig.show='hold',fig.align='center'}
...
cols <- c("x",
          ...
          "Care Continuum - How to manage patient care across 
          care settings, e.g., primary care, general mental 
          health and specialty mental health",
          "Measurement Based Care - How implementation of 
          measurement based care will improve patient 
          care or reduce patient risk",
          "Intake evaluations",
          "Care coordination",
